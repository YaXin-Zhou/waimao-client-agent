...
配置驱动的外贸客户发现、背调、数据清洗、评分、开发信和持续跟进系统。
...
- 真实数据核验：[docs/REAL_DATA_VALIDATION.md](docs/REAL_DATA_VALIDATION.md)
- 领域上下文：[CONTEXT.md](CONTEXT.md)

## 开发纪律

先更新需求和设计，再写代码；每个功能必须有测试、验收标准和变更记录。密钥、真实邮箱数据和运行产物不得提交到 Git。
