...
function mapRemoteLead(item) {
  ...
  return {
    ...
    sourceSummary: lead.source_summary || { website_count: 0, same_domain_count: 0, external_count: 0 },
    isRemote: true,
