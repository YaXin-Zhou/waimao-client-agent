...
function App() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/tasks/${remoteTaskId}/leads/${selected.domain}`)
      ...
      .then((data) => { if (!cancelled) { setSelectedResearch(data.research || null); setSelectedDraft(data.draft || null); setTranslatedDraft(null) } })
