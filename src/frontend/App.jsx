...
function ReviewControls({ lead, onReview, onSafetyCheck, safetyLoading, safetyResult, onSend, sendLoading, loading }) {
  ...
  const canSend = lead.draft.status === 'approved' && safetyResult?.allowed
